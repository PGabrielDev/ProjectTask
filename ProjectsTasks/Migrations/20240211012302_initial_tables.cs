        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AssinedId = table.Column<int>(type: "integer", nullable: true),
                    createdAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    ChangeDescription = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TaskDeinition", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TaskDeinition_Task_TaskId",
                        column: x => x.TaskId,
                        principalTable: "Task",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TaskDeinition_User_AssinedId",
                        column: x => x.AssinedId,
                        principalTable: "User",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Comment_TaskDeinition_TaskDefinitionId",
                        column: x => x.TaskDefinitionId,
                        principalTable: "TaskDeinition",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Comment_TaskDefinitionId",
                table: "Comment",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaskDeinition_AssinedId",
                table: "TaskDeinition",
                column: "AssinedId");

            migrationBuilder.CreateIndex(
                name: "IX_TaskDeinition_TaskId",
                table: "TaskDeinition",
                column: "TaskId");
